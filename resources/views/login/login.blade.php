...
<style>
    ...
    .nav-tabs .nav-link:hover {
        border-color: #9BD000 #9BD000 #9BD000;
        color: #333;
    }
...
<div class="d-flex justify-content-center">
    ...
    <div class="col-md-5" style="background-color: #1EC65B; border-radius: 15px;">
        <div class="d-flex justify-content-center">
...
<div class="col-md-12" style="text-align: center; margin-top: 30px; color: white; display: flex;justify-content: center;align-items: center;">
    <img src="{{asset('/images/logoverticalblanco.png')}}" style="width: 150px;">&nbsp; 2020 My Tranding Academy Pro All Rigth Reserved
