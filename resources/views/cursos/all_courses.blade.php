...
@section('content')
    <div class="section-landing" style="background: linear-gradient(to bottom, #222326 50%, #1C1D21 50.1%); margin-top: 180px;">
            ...
            @if ($cursos->count() > 0)
                ...
                <div class="col-md-3 mt-1" style="display: flex;align-items: center;">
                    <div style="text-align: center; padding-left: 10%;">
                        <h6>
                           <br><br>
                            <a href="{{ route('courses.show', [$last_course->slug, $last_course->course_id]) }}" class="btn btn-success float-right text-uppercase mr-4"><i class="fa fa-play"></i> Último curso visto</a>
                        </h6>
                    </div>
