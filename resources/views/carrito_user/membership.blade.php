                                    ...
                                    <div class="col-lg-4 mt-4 mb-5">
                                        <div class="card mb-5 mb-lg-0">
                                            ...
                                            <div class="card-body" style="position: relative; top:55px; z-index: 1;">
                                                ...
                                                <h5 class="p-2 text-white text-center">¡Esta membresía es para los buscadores del conocimiento, quienes quieren reforzar los principios de todo trader!</h5><br>
                                                ...
                                                <h4 class="p-2 text-azul-claro text-center">+ 1 LIVE STREAMING <br> AL MES</h4>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                    <h5 class="p-2 text-white text-center" style="font-size: 12px!important;">SI ADQUIERES TU MEMBRESIA EN FORMATO ANUAL TENDRÁS ACCESO A  <b class="text-azul-claro">2 STREAMING + CONTENIDO VIP
                                                    +</b> <b class="text-danger"> 1 MÓDULO GRATIS </b> DE NUESTRO PARTNER <b class="text-primary">MBA PRO </b> Y UN EVENTO DE <b class="text-danger">FTX LIVE</b></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 mt-4 mb-5">
                                        <div class="card mb-5 mb-lg-0">
                                            ...
                                            <div class="card-body" style="position: relative; top:55px; z-index: 1;">
                                                ...
                                                <h5 class="p-2 text-white text-center"> ¡Esta membresía es para los que ya hace trading, aprende las mejores estrategias para mejorar continuamente a través de una cuenta demo!</h5><br><br>
                                                ...
                                                <h4 class="p-2 text-orange text-center">+ 2 STREAMING <br> AL MES</h4><br>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                    <h5 class="p-2 text-white text-center" style="font-size: 12px!important;">SI ADQUIERES TU MEMBRESIA EN FORMATO ANUAL TENDRÁS ACCESO A  <b class="text-orange">4 STREAMING + CONTENIDO VIP
                                                    +</b> <b class="text-danger"> 1 MÓDULO GRATIS </b> DE NUESTRO PARTNER <b class="text-primary">MBA PRO </b> Y 1 EVENTO DE <b class="text-danger">FTX LIVE</b></h5>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-4 mt-4 mb-5">
                                        <div class="card mb-5 mb-lg-0">
                                            ...
                                            <div class="card-body" style="position: relative; top:55px; z-index: 1;">
                                                ...
                                                <h5 class="p-2 text-white text-center">Esta membresía te permite además de aprender y hacer trading, ganar ya por operación</h5><br>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                    <h5 class="p-2 text-white text-center" style="font-size: 12px!important;">SI ADQUIERES TU MEMBRESIA EN FORMATO ANUAL TENDRÁS ACCESO A  <b class="text-verde-claro">6 STREAMING + CONTENIDO VIP
                                                    +</b> <b class="text-danger">1 MÓDULO GRATIS </b> DE NUESTRO PARTNER <b class="text-primary">MBA PRO </b> Y 1 EVENTO DE <b class="text-danger">FTX LIVE</b></h5>
                                                    </div>
                                                </div>
                                            </div>
