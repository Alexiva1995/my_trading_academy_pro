                                        ...
                                        <div class="card mb-5 mb-lg-0">
                                            ...
                                            <div class="card-body" style="position: relative; top:55px; z-index: 1;">
                                                <div class="row" style="padding:20px;">
                                                    ...
                                                    @else
                                                        <h4 class="card-price text-azul-claro text-center"><del>${{$membresia->price}}</del>  ${{$membresia->descuento}}<span class="period">/Mensual</span> <del>${{$membresia->price_annual}}</del> ${{$membresia->discount_annual}}<span class="period">/Anual</span></h4>
                                                    @endif
                                        ...
                                        <div class="card mb-5 mb-lg-0">
                                            ...
                                            <div class="card-body" style="position: relative; top:55px; z-index: 1;">
                                                <div class="row" style="padding:20px;">
                                                    ...
                                                    @else
                                                        <h4 class="card-price text-orange text-center"><del>${{$membresia->price}}</del> ${{$membresia->descuento}}<span class="period">/Mensual</span> <del>${{$membresia->price_annual}}</del> ${{$membresia->discount_annual}}<span class="period">/Anual</span></h4>
