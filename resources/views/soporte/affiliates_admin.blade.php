...
<h4 class="col-md-8 white">Te damos la bienvenida a <b class="text-success">uno de los mejores y más geniales</b> programas de marketing de Afiliados del
mundo.</h4>


<h4 class="col-md-8 text-justify white">El programa de <b class="text-success">My Trading Academy Pro</b> te ayuda a que ganes dinero por aprender.
Contamos con cientos de cursos disponibles en <b class="text-success">10 idiomas diferentes</b> , listos para que los compartas con un
        ...
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card">
                ...
                <h4 class="card-text" style="padding: 10px; color: black;">
                    Intégrate a nuestra comunidad, aprende todo lo que necesitas para ser un emprendedor PRO y como miles de estudiantes alrededor del mundo regístrate a nuestro programa de Afiliados de My Trading Academy Pro y comienza a ganar dinero de inmediato.
                </h4>
                </div>
            </div>
        </div>
...
<h3 class="col-md-12 white mt-4">¿Por qué miles de personas ya eligieron el Programa de Afiliados de <b class="text-success">My Trading Academy Pro</b>?</h3>

<h1 class="col-md-4 text-success">5 Poderosas razones</h1>
...
<ol class="col-md-8">
  ...
  <li class="white"><h4 style="line-height: 28px;">Ingresa a <b class="text-success"><a class="text-success text-link-mba" href="http://mytradingacademypro.com/office">www.mytradingacademypro.com/office</a></b> , crea tu cuenta de forma gratuita rellenando algunos datos de forma breve y listo comienza a recomendar aquellos cursos que te encanten.</h4></li><br>
...
<div class="col-md-12">
<h2 class="col-md-12 text-success">Comisiones afiliados</h2>
